...
class PostAsyncTask extends AsyncTask<Void, Integer, HttpEntity> {
	...
	protected HttpEntity doInBackground(Void... params) {
		...
		case Register:
			break;
		case GetOpinions:
			postData.add(new BasicNameValuePair("moprosition", this.postId));
			break;
		default:
	...
	private void respond(String json){
		...
		case PostOpinion:
			...
			break;
		case GetOpinions:
			act.getOpinionsReturned(rr.success, rr.ownOpinion, rr.totalLikes, rr.totalDislikes);
			break;
		default:
